...
public class DialogUtils {
    ...
    private static void showMiscOptions(Context context) {
        ...
        Switch[] switches = new Switch[]{createSwitch(context, "Disable Story Auto-Swipe", FeatureFlags.disableStoryFlipping), createSwitch(context, "Disable Video Autoplay", FeatureFlags.disableVideoAutoPlay), createSwitch(context, "Show Follower Toast", FeatureFlags.showFollowerToast), createSwitch(context, "Show Feature Toasts", FeatureFlags.showFeatureToasts), createSwitch(context, "View Story Metadata (Hidden Mentions)", FeatureFlags.viewStoryMetadata)};
            ...
            switches[i].setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                switch (index) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        FeatureFlags.viewStoryMetadata = isChecked;
                        break;
                }
